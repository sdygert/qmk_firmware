...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  KC_LSFT,  CTL_T(KC_Z),    ALT_T(KC_X),    SFT_T(KC_C),    KC_V,           KC_B,           LCA(KC_NO),           KC_NO,    KC_N,           KC_M,           SFT_T(KC_COMM), ALT_T(KC_DOT),     CTL_T(KC_SLSH),    KC_RSFT,
...
[SYMB] = LAYOUT_ergodox_pretty(
  ...
  KC_TRNS, KC_EQL,  KC_TRNS, KC_TRNS, KC_TRNS,                                         KC_0,    KC_DOT,  KC_0,    KC_EQL,  KC_TRNS,
