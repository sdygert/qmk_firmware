 ...
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | Del    |   Q  |   W  |   E  |   R  |   T  |DMPLY1|           |  L1  |   Y  |U/ L2 |   I  |   O  |   P  | \/F12  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | BkSp   |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |   ;  |' / Cmd |
 * |--------+------+------+------+------+------|      |           |  L2  |------+------+------+------+------+--------|
 * | LShft  |Z/Ctrl|X/Alt |C/Shft|V/Meh |   B  |      |           |      |N /Meh|M/Ctrl|,/Shft|./Alt |   /  | RShft  |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  KC_DEL,   KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           DM_PLY1,              TG(1),    KC_Y,           LT(2,KC_U),     KC_I,           KC_O,              KC_P,              LT(0,KC_BSLS),
  KC_BSPC,  KC_A,           KC_S,           KC_D,           KC_F,           KC_G,                                           KC_H,           KC_J,           KC_K,           KC_L,              KC_SCLN            GUI_T(KC_QUOT),
  KC_LSFT,  CTL_T(KC_Z),    ALT_T(KC_X),    SFT_T(KC_C),    MEH_T(KC_V),    KC_B,           KC_NO,                TG(2),    MEH_T(KC_N),    CTL_T(KC_M),    SFT_T(KC_COMM), ALT_T(KC_DOT),     KC_SLSH,           KC_RSFT,
  KC_EQL,   KC_LBRC,        KC_RBRC,        KC_LEFT,        KC_RGHT,                                                        KC_UP,          KC_DOWN,        KC_NO,          KC_CAPS,           KC_PSCR,
                                                                            KC_LALT,        KC_LGUI,              KC_LALT,  KC_ESC,
                                                                                            KC_HOME,              KC_PGUP,
                                                            KC_SPC,         KC_NO,          KC_END,               KC_PGDN,  KC_TAB,         LT(2,KC_ENT)
),
/* Keymap 1: Symbol Layer
 *
 * ,---------------------------------------------------.           ,--------------------------------------------------.
 * |   Esc   |  F1  |  F2  |  F3  |  F4  |  F5  |DMREC2|           |      |  F6  |  F7  |  F8  |  F9  |  F10 |   F11  |
 * |---------+------+------+------+------+------+------|           |------+------+------+------+------+------+--------|
 * |         |   !  |   @  |   {  |   }  |   |  |DMPLY2|           |      |  Up  |   7  |   8  |   9  |   *  |   F12  |
 * |---------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |         |   #  |   $  |   (  |   )  |   `  |------|           |------| Down |   4  |   5  |   6  |   +  |        |
...
[SYMB] = LAYOUT_ergodox_pretty(
  // left hand
  KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   DM_REC2,     KC_TRNS, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
  KC_TRNS, KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, KC_PIPE, DM_PLY2,     KC_TRNS, KC_UP,   KC_7,    KC_8,    KC_9,    KC_ASTR, KC_F12,
...
[MOUS] = LAYOUT_ergodox_pretty(
  // left hand
  KC_TRNS, KC_TRNS, KC_TRNS, MS_BTN3, KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS, LCTL(KC_C), LCTL(KC_V),   KC_BSPC, KC_TRNS, KC_TRNS, KC_TRNS,
  KC_TRNS, KC_TRNS, MS_BTN1, MS_UP,   MS_BTN2, KC_TRNS, KC_TRNS,     KC_TRNS, KC_MPLY,    MS_ACL0,      MS_ACL1, MS_ACL2, KC_TRNS, KC_TRNS,
  KC_TRNS, KC_TRNS, MS_LEFT, MS_DOWN, MS_RGHT, KC_TRNS,                       MS_WHLL,    MS_WHLD,      MS_WHLU, MS_WHLR, KC_TRNS, KC_TRNS,
  ...
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                                            KC_TRNS,      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                                               ...
                                               KC_TRNS, KC_TRNS,     KC_TRNS, KC_TRNS,
                                                        KC_TRNS,     KC_TRNS,
                                      MS_BTN1, MS_BTN2, KC_TRNS,     KC_TRNS, MS_BTN1,    MS_BTN2
),
